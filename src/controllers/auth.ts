...
export default class AuthController {
  ...
  static async sendGmailForForgotPassword(req: Request, res: Response) {
    ...
    if (!account)
      ...
      await AccountOptService.postAccountOtp(account.email, OtpEnum.FORGET, otp, tokenExpiration);
  ...
  static async sendGmailForVerifingEmail(req: Request, res: Response) {
    ...
    await AccountOptService.postAccountOtp(data.email, OtpEnum.VERIFICATION, otp, tokenExpiration);
    let name = "Guest";
  ...
  static async resetPassword(req: Request, res: Response) {
    ...
    if (!account)
      ...
      if (result.getCode() != StatusCodes.OK)
        ...
        const reset = await AuthService.resetPassword(account.id, data.password);
        if (reset.getCode() == StatusCodes.OK)
          await AccountOptService.deleteAccountOtp(account.email, OtpEnum.FORGET, data.otp);
