const resetPassword = function (otp: string, name: string) {
  const html = `
    <!DOCTYPE html>
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested from ShopP. Use to reset your ShopP account password.
                      </p>
...
const verifyEmail = function (otp: string, name: string) {
  const html = `
    <!DOCTYPE html>
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
...
export default { resetPassword, verifyEmail };
